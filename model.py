...
class TreeModel:
    ...
    def generate_greedy_multiverse(self, prompt=None, node=None, ground_truth=None, max_depth=3, unnormalized_amplitude=1, unnormalized_threshold=0.1, engine='ada'):
